...
// 2. Migrate (prod mode): Apply incremental migrations from current to target version
// 3. Migrate (dev mode): Seed database with dev data
//
// Migration Files:
...
// getMigrationBasePath returns the base path for migration files.
// The base path is determined by the driver and the minor version of the current version.
